...
export const Register = () => {
    ...
    function signup(e) {
        e.preventDefault();
        if (firstname == "" && lastname == "" && email == "" && username == "" && password == "" && contact == "" && tipo == "") {
            Swal.fire({icon: "error", title: "Ups...", text: "¡Faltan datos por completar!"});
        } else if (tipo == "refugio" && empresa == "") {
            Swal.fire({icon: "error", title: "Ups...", text: "¡Faltan datos por completar!"});
        } else if ((store.imagePet == "" || store.imagePet == undefined) && tipo == "refugio") {
            Swal.fire({icon: "error", title: "Ups...", text: "La imagen no quedo subida correctamente"});
        } else {
            actions.signup(username, email, password, firstname, lastname, contact, tipo, store.imagePet, empresa);
            setFirstname("");
            setLastname("");
            setEmail("");
            setUsername("");
